...
const NoteCard = ({ item, setNoteToEdit, setCurrentPage, deleteNote }) => (
...
const Home = ({ noteList, setCurrentPage, setNoteToEdit, deleteNote }) => (
    <View style={styles.container}>
        ...
        <FlatList
            ...
            renderItem={({ item }) => (
                <NoteCard item={item} setCurrentPage={setCurrentPage} deleteNote={deleteNote} setNoteToEdit={setNoteToEdit} />
            )}
